...
while cont > 0: 
    ...
    match (opcoes_1):
        ...
        #O USUÁRIO ESTÁ RESTRITO A CADASTRAS TODOS OS LIVROS DE UMA VEZ E CASO QUEIRA ATUALIZAR A LISTA DE LIVROS, ELE PRECISARÁ RECADASTRAR TODOS OS LIVROS NOVAMENTE;
        ...
        case 3:
            ...
            #FOI DEFINIDO OUTRO LOOP PARA APARECER O MENU DE OPÇÕES ATÉ QUE O USUÁRIO ESCOLHA FINALIZAR AS OPERAÇÕES;
